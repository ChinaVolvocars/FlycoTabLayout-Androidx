...
#### [中文版](https://github.com/ChinaVolvocars/FlycoTabLayout-Androidx/blob/master/README_CN.md)
An Androidx TabLayout Lib has 3 kinds of TabLayout at present.
...
## Demo
![](https://github.com/ChinaVolvocars/FlycoTabLayout-Androidx/blob/master/preview_1.gif)

![](https://github.com/ChinaVolvocars/FlycoTabLayout-Androidx/blob/master/preview_2.gif)

![](https://github.com/ChinaVolvocars/FlycoTabLayout-Androidx/blob/master/preview_3.gif)
...
allprojects {
    repositories {
        ...
        jcenter()
        //add
        maven { url 'https://dl.bintray.com/tiger/maven' }
    }
}

  implementation 'com.flyco.tablayout.androidx:FlycoTabLayout_Lib:1.0.0'
```
